...
import requests
import base64
from script import VPNConverter  # Pastikan class VPNConverter ada get_file_from_github
...
def start_batch_test(configs, tag_list, provider_list, country_list):
    filtered = []
    for cfg, tag, provider, country in zip(configs, tag_list, provider_list, country_list):
